...
| **M5** iOS 端 | SwiftUI UI + NSURLSession/Keychain/PDFKit + 自检入口（**framework + Swift 冒烟 + SwiftUI App 骨架跑通模拟器已完成**；四个端口待补） | **12–16 天** | 自检项与 Android **等价**；检索 **Hit@1 87% / Hit@3 100% / MRR 0.928**（同语料同模型）；路由事件与 Android 同构；**P2** 跨语言调用 ≤5 µs |
