...
| 5 | Kotlin 升到 ≥2.2.21（owner 已同意）+ AGP 9 对齐；**单独提交 + 回滚 tag** | Android 全量验证复跑：**207 测试** + 自检 27/27 + 检索评测 |
