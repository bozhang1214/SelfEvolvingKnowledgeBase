...
分类规则：
1. 必须从上述目录中选择，不可自创分类
2. 以文档的「主题 / 知识领域」为准，而不是文档形式（大纲/教程/笔记都是形式）。
   例如《Python学习大纲》《Python入门教程》应归入「技术开发/编程语言/Python」，
   而不是「学习成长/课程学习」；「学习成长」大类只用于与具体技术主题无关的
   通用学习方法、阅读笔记、课程规划、职业发展类内容。
3. 优先匹配到最具体的细类（l3）
4. 如果文档内容跨多个类别，选择最主要的一个
5. confidence 表示你对本次分类的把握（0.0~1.0），把握不大时给低分
